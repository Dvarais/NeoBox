...
#### Steps
1. Download the latest installer `NeoBox_Setup_v1.6.1.exe` or the standalone executable `NeoBox.exe` from the Releases section of the GitHub repository.
...
#### Шаги установки
1. Загрузите актуальный установщик `NeoBox_Setup_v1.6.1.exe` or портативную версию `NeoBox.exe` из раздела релизов (Releases) репозитория на GitHub.
